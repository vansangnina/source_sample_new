<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.timkiem button').click(function(event) {
			...
			window.location.href="index.php?com=user&act=man&type=<?=$type?>&keyword="+keyword;
		});
    ...
    $("#xoahet").click(function(){
      ...
      if (hoi==true) document.location = "index.php?com=user&act=delete&type=<?=$type?>&curPage=<?=$curPage?>&listid=" + listid;
    });
	});
</script>
