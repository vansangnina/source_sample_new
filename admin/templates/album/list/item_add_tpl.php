...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=album&act=add_list<?php if($type!='') echo'&type='. $type;?>"><span>Thêm <?=$title_main?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=album&act=save_list<?php if($type!='') echo'&type='. $type;?>" method="post" enctype="multipart/form-data">
...
<?php if($config_images=="true"){ ?>
	...
	<?php if($_GET['act']=='edit_list'){?>
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=UPLOAD_ALBUM.$item['thumb']?>"  alt="NO PHOTO"  /></div>
			</div>
			<div class="clear"></div>
		</div>
	<?php } ?>	
	...
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=album&act=man_list<?php if($type!='') echo'&type='. $type;?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
