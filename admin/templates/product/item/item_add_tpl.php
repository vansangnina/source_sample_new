...
<script type="text/javascript">		
	...
	function select_list()
	{
		...
		window.location ="index.php?com=product&act=<?php if($act=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if($id!='') echo"&id=".$id; ?><?php if($type!='') echo"&type=".$type; ?>&id_list="+a.value;	
		return true;
	}	
	...
	function select_cat()
	{
		...
		window.location ="index.php?com=product&act=<?php if($act=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if($id!='') echo"&id=".$id; ?><?php if($type!='') echo"&type=".$type; ?>&id_list="+a.value+"&id_cat="+b.value;	
		return true;
	}
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=product&act=add_item<?php if($type!='') echo'&type='. $type;?>"><span>Thêm Danh mục cấp 3</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save_item<?php if($type!='') echo'&type='. $type;?>" method="post" enctype="multipart/form-data">
	...
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=product&act=man_item<?php if($type!='') echo'&type='. $type;?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
