...
<form name="supplier" id="validate" class="form" action="index.php?com=info&act=save<?php if($type!='') echo'&type='. $type;?>" method="post" enctype="multipart/form-data">

	<div class="control_frm" style="margin-top:25px;">
	    <div class="bc">
	        <ul id="breadcrumbs" class="breadcrumbs">
	        	<li><a href="index.php?com=info&act=capnhat<?php if($type!='') echo'&type='. $type;?>"><span>Cập nhật <?=$title_main?></span></a></li>
	        </ul>
	        <div class="clear"></div>
	    </div>
	</div>
...
<?php if($config_images=='true'){ ?>
	<div class="formRow">
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=UPLOAD_IMAGE.$item['thumb']?>"  alt="NO PHOTO"  /></div>
			</div>
			<div class="clear"></div>
		</div>
<?php } ?>
