<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.timkiem button').click(function(event) {
			...
			window.location.href="index.php?com=contact&act=man&type=<?=$type?>&keyword="+keyword;
		});
    ...
    $("#xoahet").click(function(){
      ...
      if (hoi==true) document.location = "index.php?com=contact&act=delete&type=<?=$type?>&curPage=<?=$curPage?>&listid=" + listid;
    });
	});
</script>
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=contact&act=man<?php if($type!='') echo'&type='. $type;?>"><span>Quản lý thông tin liên hệ</span></a></li>
        	<?php if($keyword!=''){ ?>
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
       ...
       <td>
        ...
        <td class="actBtns">
            <a href="index.php?com=contact&act=edit&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id=<?=$items[$i]['id']?><?php if($type!='') echo'&type='. $type;?>" title="" class="smallButton tipS" original-title="Xem"><img src="./images/icons/dark/pencil.png" alt=""></a>

            <a href="index.php?com=contact&act=delete&id=<?=$items[$i]['id']?><?php if($type!='') echo'&type='. $type;?>" onClick="if(!confirm('Xác nhận xóa')) return false;" title="" class="smallButton tipS" original-title="Xóa"><img src="./images/icons/dark/close.png" alt=""></a>
        </td>
      </tr>
         <?php } ?>
                </tbody>
