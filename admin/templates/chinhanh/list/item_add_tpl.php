...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=chinhanh&act=add_list<?php if($type!='') echo'&type='. $type;?>"><span>Thêm <?=$title_list?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=chinhanh&act=save_list<?php if($type!='') echo'&type='. $type;?>" method="post" enctype="multipart/form-data">
<!--thong tin chung-->
<div class="widget">
