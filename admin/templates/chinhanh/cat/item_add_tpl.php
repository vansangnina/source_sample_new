...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=chinhanh&act=add_list<?php if($type!='') echo'&type='. $type;?>"><span>Thêm <?=$title_cat?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=chinhanh&act=save_cat<?php if($type!='') echo'&type='. $type;?>" method="post" enctype="multipart/form-data">
...
<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=chinhanh&act=man_list<?php if($type!='') echo'&type='. $type;?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
