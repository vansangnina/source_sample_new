...
function get_main_sub()
  {
  	global $item,$d,$type,$lang;
    $sql="select ten_$lang as ten,id from table_chinhanh_sub where id_item='".$item['id_item']."' and type='".$type."' order by stt asc";
    $d->query($sql);
    $result = $d->result_array();
    $str='
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=chinhanh&act=add_list<?php if($type!='') echo'&type='. $type;?>"><span>Thêm <?=$title_main?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=chinhanh&act=save<?php if($type!='') echo'&type='. $type;?>" method="post" enctype="multipart/form-data">
...
<div class="widget">
	...
	<div class="formRow">
		...
		<div class="mt10"><img src="<?=UPLOAD_BRANCH.$item['thumb']?>"  alt="NO PHOTO" width="100" /></div>
		</div>
		<div class="clear"></div>
	</div>
	<?php } } ?>
  ...
  <?php if(count($ds_photo)!=0){?>       
        <?php for($i=0;$i<count($ds_photo);$i++){?>
          <div class="item_trich">
              <img class="img_trich" width="140px" height="110px" src="<?=UPLOAD_BRANCH.$ds_photo[$i]['photo']?>" />
...
<div class="widget">
	<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=chinhanh&act=man<?php if($type!='') echo'&type='. $type;?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
</div>
